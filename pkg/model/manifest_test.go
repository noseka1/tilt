...
var equalitytests = []struct {
	...
	{
		"LocalTarget equal",
		Manifest{}.WithDeployTarget(NewLocalTarget("foo", ToHostShellCmd("beep boop"), Cmd{}, []string{"bar", "baz"}, "path/to/tiltfile")),
		Manifest{}.WithDeployTarget(NewLocalTarget("foo", ToHostShellCmd("beep boop"), Cmd{}, []string{"bar", "baz"}, "path/to/tiltfile")),
		true,
		false,
	},
	{
		...
		Manifest{}.WithDeployTarget(NewLocalTarget("foo", ToHostShellCmd("beep boop"), Cmd{}, []string{"bar", "baz"}, "path/to/tiltfile")),
		Manifest{}.WithDeployTarget(NewLocalTarget("foooooo", ToHostShellCmd("beep boop"), Cmd{}, []string{"bar", "baz"}, "path/to/tiltfile")),
		false,
		true,
	},
	{
		...
		Manifest{}.WithDeployTarget(NewLocalTarget("foo", ToHostShellCmd("beep boop"), Cmd{}, []string{"bar", "baz"}, "path/to/tiltfile")),
		Manifest{}.WithDeployTarget(NewLocalTarget("foo", ToHostShellCmd("bippity boppity"), Cmd{}, []string{"bar", "baz"}, "path/to/tiltfile")),
		false,
		true,
	},
	{
		...
		Manifest{}.WithDeployTarget(NewLocalTarget("foo", ToHostShellCmd("beep boop"), Cmd{}, []string{"bar", "baz"}, "path/to/tiltfile")),
		Manifest{}.WithDeployTarget(NewLocalTarget("foo", ToHostShellCmd("beep boop"), Cmd{}, []string{"quux", "baz"}, "path/to/tiltfile")),
		false,
		true,
	},
	{
		...
		Manifest{}.WithDeployTarget(NewLocalTarget("foo", ToHostShellCmd("beep boop"), Cmd{}, []string{"bar", "baz"}, "path/to/tiltfile")),
		Manifest{}.WithDeployTarget(NewLocalTarget("foo", ToHostShellCmd("beep boop"), Cmd{}, []string{"bar", "baz"}, "some/other/path")),
		false,
		true,
	},
}
